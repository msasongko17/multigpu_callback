...
#SBATCH -J callback8 		 # Job Name
#SBATCH -N 1 				 # Number of Nodes
#SBATCH -n 8 				 # Number of tasks per Node
#SBATCH -c 16			 # Number of cores per Node
#SBATCH --gres=gpu:8 		 # GPU resources (can request specific as gpu:tesla_v100:1)
#SBATCH --time=00:15:00		 # Time day-hours:minutes:seconds
#SBATCH --output=callback_8tasks.out	 # Standard output and error log to this file
lscpu
